package com.emperises.monercat.push;
...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public void onMessage(Context context, String message, String customContentString) {
		String messageString = "透传消息 message=\"" + message + "\" customContentString="
				+ customContentString;
		Log.d("PUSH", messageString);
//		if(!TextUtils.isEmpty(message) && message.contains("startPic")){
//			StartPicObj pic = new Gson().fromJson(message, StartPicObj.class);
//			if(pic != null){
//				WeiPinUtil.download(pic.getStartPic()	, new File(context.getCacheDir().getAbsoluteFile(),"start.png"));
//			}
//		}
	}
	...
	public static String PUSH_CUSTOMCONTENTSTRING = "customContentString";
	public static String HAVE_PUSH = "havepush";
	@Override
