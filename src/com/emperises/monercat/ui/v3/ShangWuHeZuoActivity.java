...
public class ShangWuHeZuoActivity extends OtherBaseActivity {
	...
	protected void initViews() {
		...
		mAdWebView.loadUrl("http://115.28.136.194:8086/zcm/ex/zcm/bussnise.html");
		mAdWebView.setWebChromeClient(new WebChromeClient(){
			@Override
			public void onProgressChanged(WebView view, int newProgress) {
				if(newProgress == 100){
					setCurrentTitle(getString(R.string.hezuo));
				}
