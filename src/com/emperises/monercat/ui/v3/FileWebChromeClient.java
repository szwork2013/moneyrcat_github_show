...
abstract public class FileWebChromeClient extends WebChromeClient {
	private WebChromeClient mWrappedClient;
    protected FileWebChromeClient(WebChromeClient wrappedClient) {
    ...
    public void openFileChooser(ValueCallback<Uri> uploadFile) {
        ((FileWebChromeClient) mWrappedClient).openFileChooser(uploadFile);
    }
    public void openFileChooser( ValueCallback<Uri> uploadMsg, String acceptType ){
    	((FileWebChromeClient) mWrappedClient).openFileChooser(uploadMsg, acceptType);
    }
    public void openFileChooser(ValueCallback<Uri> uploadMsg, 
    		                String acceptType, String capture) {
    	((FileWebChromeClient) mWrappedClient).openFileChooser(uploadMsg, acceptType, capture);
